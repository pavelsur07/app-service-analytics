...
final class Version20260808181519 extends AbstractMigration
{
    ...
    {
        return 'Raw-слой: marketplace_raw_document (ADR-006), body — text, не jsonb: сохраняется точно как получено, без требования валидного JSON. messenger_messages — таблица Doctrine-транспорта.';
    }
