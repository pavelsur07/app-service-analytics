 ...
 * пропавшее поле — ошибка разбора, а не пустое значение. Правило
 * «неизвестный ключ — ошибка» (ADR-026, п. 4) написано для статистики,
 * где переименованная колонка превратилась бы в нули поверх настоящих
 * сумм. Здесь денег нет, а у кампании десятки служебных полей, которые
 * площадка добавляет по ходу: строгость к ним сломала бы подключение
 * рекламы, ничего не защитив.
 */
