 ...
 *
 * Одного этого эндпоинта достаточно: sku приходит прямо в списке.
 * v3/product/info/list с деталями (названия, цены, комиссии) сюда
 * не ходит — проверено на фикстуре 2026-08-13, sku там те же
 * до последнего товара, а лишний поход в кабинет стоит лимита запросов
