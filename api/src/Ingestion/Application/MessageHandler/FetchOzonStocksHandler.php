 ...
 * читает их лениво из raw по одной пачке и вставляет порциями — в штатном
 * режиме (тела в S3) память ограничена пачкой, а не каталогом (исключение —
 * аварийный режим ADR-025, см. StockSnapshotRawReader), и день заодно
