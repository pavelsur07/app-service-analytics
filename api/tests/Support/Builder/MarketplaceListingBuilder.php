 ...
 *
 * Момент синхронизации задаётся снаружи: по нему writer решает, какие
 * строки исчезли, и это ровно то, что проверяет тест — билдер не должен
 * вычислять проверяемое значение сам.
 */
