...
IngestionPlanningFacade::knownMarketplaceSkus(
    ...
    string $marketplaceAccountId,
    array $marketplaceSkus,
): array; // list<string>, только существующие SKU этого кабинета, максимум 200

IngestionPlanningFacade::knownMarketplaceSkusForPlanImport(
    string $companyId,
    string $marketplaceAccountId,
    array $marketplaceSkus,
): array; // list<string>, только для одного XLSX, максимум 10 000

IngestionPlanningFacade::knownMarketplaceSkuDetailsForPlanImport(
    string $companyId,
    string $marketplaceAccountId,
    array $marketplaceSkus,
): array; // list<MarketplaceSku>, только для preview одного XLSX, максимум 10 000; ADR-025
