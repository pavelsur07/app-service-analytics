...
export interface paths {
    ...
    "/api/companies/{companyId}/connections/{marketplaceAccountId}/advertising-credentials": {
        ...
        get?: never;
        put: operations["put_ingestion_connection_advertising_credentials_replace"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
...
export interface operations {
    ...
    put_ingestion_connection_advertising_credentials_replace: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody?: {
            content: {
                "application/json": {
                    /** @description client_id сервисного аккаунта Performance API */
                    clientId: string;
                    clientSecret: string;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ConnectedAdvertisingResponse"];
                };
            };
            /** @description Пользователь не состоит в этой компании */
            403: {
